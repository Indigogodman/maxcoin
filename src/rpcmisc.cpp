...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    ...
    obj.push_back(Pair("version", supermaxcoin_VERSION));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"supermaxcoinaddress\"\n"
            "\nReturn information about the given supermaxcoin address.\n"
            "\nArguments:\n"
            "1. \"supermaxcoinaddress\"     (string, required) The supermaxcoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"supermaxcoinaddress\", (string) The supermaxcoin address validated\n"
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are supermaxcoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) supermaxcoin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"supermaxcoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"supermaxcoinaddress\"  (string, required) The supermaxcoin address to use for the signature.\n"
