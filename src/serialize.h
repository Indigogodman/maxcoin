...
enum
{
    ...
    // modifiers
    SER_POSMARKER       = (1 << 18),  // supermaxcoin: for sending block headers with PoS marker, to allow headers-first syncronization
    SER_BTC_TX          = (1 << 19),  // supermaxcoin: for merged mining, to read tx without nTime.
};
