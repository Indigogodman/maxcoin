...
public:
    ...
    int32_t nVersion;     // supermaxcoin: it might contain merged mining information in higher bits. Use GetBlockVersion() to ignore it.
    ...
    // supermaxcoin: copy from CBlockIndex.nFlags from other clients. We need this information because we are using headers-first syncronization.
    int32_t nFlags;
