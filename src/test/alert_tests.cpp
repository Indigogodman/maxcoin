...
BOOST_AUTO_TEST_CASE(AlertApplies)
{
    ...
    // supermaxcoin: TODO: sign alerts with supermaxcoin key
...
//    }
    ...
    // Matches:
    // supermaxcoin: for some bitcoin test alerts are read with nExpiration == 0, making following tests fail.
...
BOOST_AUTO_TEST_CASE(AlertNotify)
{
    ...
    // supermaxcoin: following tests requires alertnotify.txt to exist, but for some reason this file is deleted at next instruction...
