...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("supermaxcoin Core supermaxcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  supermaxcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded supermaxcoin transaction") + "\n" +
              "  supermaxcoin-tx [options] -create [commands]   " + _("Create hex-encoded supermaxcoin transaction") + "\n" +
              "\n";
