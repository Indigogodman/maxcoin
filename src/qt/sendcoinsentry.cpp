    ...
    model(0)
{
    ...
    ui->payTo->setValidator(0);  // supermaxcoin: disable validator so that we can type names
    ui->payAmountExch->setValidator( new QDoubleValidator(0, 1e20, 8, this) );
    qsExchInfo = "<html><head/><body><p><span style=\" font-weight:600;\">"+
            tr("WARNING: You're using external service! supermaxcoin is not responsible for functionality and correct behavior of this service.")+"</span><br/>"+
...
void SendCoinsEntry::setModel(WalletModel *model)
{
    ...
    // supermaxcoin: initialize exchange box
