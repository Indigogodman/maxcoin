...
<context>
    ...
    <message>
        ...
        <translation>Это ваши адреса supermaxcoin для отправки платежей. Всегда проверяйте количество и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши адреса supermaxcoin для приёма платежей. Рекомендуется использовать новый адрес получения для каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>supermaxcoin Core клиент</translation>
    </message>
    <message>
    ...
    <message>
        <source>Send coins to a supermaxcoin address</source>
        <translation>Отправить монеты на адрес supermaxcoin</translation>
    </message>
    <message>
        <source>Modify configuration options for supermaxcoin</source>
        <translation>Изменить параметры конфигурации supermaxcoin</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать информацию о supermaxcoin Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения вашим адресом supermaxcoin, чтобы доказать, что вы им владеете</translation>
    </message>
    <message>
        <source>Verify messages to ensure they were signed with specified supermaxcoin addresses</source>
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определённым адресом supermaxcoin</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message>
        ...
        <translation>Запросить платежи (создаёт QR-коды и supermaxcoin: ссылки)</translation>
    </message>
    <message>
        <source>&amp;About supermaxcoin Core</source>
        <translation>&amp;О supermaxcoin Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть supermaxcoin: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать помощь по supermaxcoin Core и получить список доступных параметров командной строки.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введённый адрес "%1" не является правильным supermaxcoin-адресом.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Добро пожаловать в supermaxcoin Core.</translation>
    </message>
    <message>
        ...
        <translation>Так как вы впервые запустили программу, вы можете выбрать, где supermaxcoin Core будет хранить данные.</translation>
    </message>
    <message>
        ...
        <translation>supermaxcoin Core скачает и сохранит копию цепи блоков. Как минимум, %1ГБ данных будет храниться в этом каталоге, и со временем он будет расти. Бумажник будет также сохранён в этом каталоге.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Автоматически запускать supermaxcoin после входа в систему</translation>
    </message>
    <message>
        <source>&amp;Start supermaxcoin on system login</source>
        <translation>&amp;Запускать supermaxcoin при входе в систему</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для supermaxcoin-клиента на роутере. Работает только если Ваш роутер поддерживает UPnP, и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети supermaxcoin через прокси SOCKS5</translation>
    </message>
    <message>
        <source>&amp;Connect through SOCKS5 proxy (default proxy):</source>
        <translation>&amp;Подключаться к сети supermaxcoin через прокси SOCKS5 (прокси по умолчанию):</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Здесь можно выбрать язык интерфейса. Настройки вступят в силу после перезапуска supermaxcoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш бумажник автоматически синхронизируется с сетью supermaxcoin после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить supermaxcoin: обработчик click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось обработать URI! Это может быть связано с неверным адресом supermaxcoin или неправильными параметрами URI.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес supermaxcoin (например, %1)</translation>
    </message>
    <message>
        <source>%1 d</source>
...
<context>
    ...
    <message>
        ...
        <translation>Открыть отладочный лог-файл supermaxcoin из текущего каталога данных. Это может занять несколько секунд для больших лог-файлов.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Добро пожаловать в RPC-консоль supermaxcoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Заметьте: сообщение не будет отправлено вместе с платежом через сеть supermaxcoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: неверный адрес supermaxcoin</translation>
    </message>
    <message>
        <source>(no label)</source>
        <translation>[нет метки]</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес supermaxcoin, на который отправить платёж</translation>
    </message>
    <message>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <translation>К supermaxcoin: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть supermaxcoin.</translation>
    </message>
    <message>
    ...
    <message>
        <source>WARNING: You're using external service! supermaxcoin is not responsible for functionality and correct behavior of this service.</source>
...
<context>
    ...
    <message>
        ...
        <translation>supermaxcoin Core выключается...</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес supermaxcoin, которым подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выберите ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение адресом supermaxcoin</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;Сообщение</translation>
    ...
    <message>
        ...
        <translation>Адрес supermaxcoin, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified supermaxcoin address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным адресом supermaxcoin</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;Сообщение</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Разработчики supermaxcoin Core</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удалось забиндиться на %s на этом компьютере. Возможно, supermaxcoin Core уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось установить блокировку на каталог данных %s. Возможно, supermaxcoin Core уже запущен.</translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "supermaxcoin Alert" admin@foo.com
        ...
        <translation>Для использования supermaxcoind или опции supermaxcoin-qt -server, вы должны установить опцию rpcpassword в конфигурационном файле:
 %s
...
Например: alertnotify=echo %%s | mail -s "supermaxcoin Alert" admin@foo.com
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Внимание: убедитесь, что дата и время на Вашем компьютере выставлены верно. Если Ваши часы идут неправильно, supermaxcoin Core будет работать некорректно.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Все права защищены © 2013-%i Разработчики supermaxcoin Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ошибка загрузки wallet.dat: бумажник требует более новую версию supermaxcoin Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось проверить чистоту. supermaxcoin Core выключается.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Параметры RPC SSL: (см. supermaxcoin вики для инструкций по настройке SSL)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необходимо перезаписать бумажник, перезапустите supermaxcoin Core для завершения операции.</translation>
    </message>
    <message>
