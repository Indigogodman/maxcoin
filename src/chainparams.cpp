...
public:
    CMainParams() {
         ...
         *   vMerkleTree: 4a5e1e
         */
        const char* pszTimestamp = "OFIGENNAYA PHRAAZA";
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1531491430;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 1329946546u;

        hashGenesisBlock = genesis.GetHash();
        std::cout<<hashGenesisBlock.ToString().c_str()<<" LOL "<<genesis.hashMerkleRoot.ToString().c_str();
        assert(hashGenesisBlock == uint256("0x7723b39a76c0268ca044e1c13062d0465dc1b7f651bee1710094770f19ef91e9"));

        assert(genesis.hashMerkleRoot == uint256("0x418e4492d85a21b643ed37385803e905ccaeec8c150807278aea87d32ecc8dfa"));

        vSeeds.push_back(CDNSSeedData("supermaxcoin.com", "seed.supermaxcoin.com"));
        vSeeds.push_back(CDNSSeedData("supermaxcoin.net", "seed.supermaxcoin.net"));
        vSeeds.push_back(CDNSSeedData("emergate.net", "seed.emergate.net"));
        vSeeds.push_back(CDNSSeedData("emcdns", "seed.emc"));

        base58Prefixes[PUBKEY_ADDRESS] = list_of(33);   // supermaxcoin: addresses begin with 'E'
        base58Prefixes[SCRIPT_ADDRESS] = list_of(92);   // supermaxcoin: addresses begin with 'e'
...
public:
    CTestNetParams() {
        ...
        hashGenesisBlock = genesis.GetHash();
        std::cout<<" NIZ "<<hashGenesisBlock.ToString().c_str();
        assert(hashGenesisBlock == uint256("0x8d799c7b75f2eec5577132a358acf757e6519aabfd7600a5399da37f3474baaa"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("supermaxcoin", "tnseed.supermaxcoin.com"));
...
public:
    CRegTestParams() {
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 6664;
        std::cout<<" NIZNIZ "<<hashGenesisBlock.ToString().c_str();
        assert(hashGenesisBlock == uint256("0x8d799c7b75f2eec5577132a358acf757e6519aabfd7600a5399da37f3474baaa"));
